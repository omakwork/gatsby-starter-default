...
<h1 align="center">
  Gatsby's default starter using TypeScript
</h1>
...
1.  **Create a Gatsby site.**
    ...
    gatsby new my-default-starter https://github.com/omakwork/gatsby-starter-default-typescript
    ```
...
4.  **`.eslintrc.js`**: This is a configuration file for [ESLint](https://eslint.org/). ESLint statically analyzes your code to quickly find problems.
